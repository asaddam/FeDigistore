...
const UpdateCategory = ({ match }) => {
    ...
    // destructure user dan token dari localStorage
    ...
    const updateCategoryForm = () => (
        <div className="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
            <form className="mb-5" onSubmit={submitCategoryForm}>
                <span className="login100-form-title p-b-32 m-b-7">Form Update Kategori</span>
                <span className="txt1 p-b-11">Nama Kategori</span>
                <br />
                <br />
    ...
    return (
        <Layout
            title={`Hi ${user.name}`}
            description={`Halaman Update Produk`}
